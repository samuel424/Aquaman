<?php
    ...
    $sql = "SELECT fr.FreezerID, fr.FModel, l.LabID, l.LabName, l.Country, l.City, l.LabAddress 
    FROM Freezer AS fr 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!empty($_POST["search"])){
            $result = mysqli_query($link,$sql." WHERE FreezerID LIKE '%".$clean["search"]."%'");
            if (mysqli_num_rows($result) == 0) {
                dconnect($link);
                header('Location: form_freezer.php?error=noresults');
                exit;
            }
        } else {
...
font-family: "Trirong", serif;
    ...
    <div class="body"><!--Content-->
        ...
        <!-- form -->
        <form action="add_freezer.php" method="POST" style="border:1px solid #ccc">
        <h2>Add Freezer </h2>
            <label for="model">Freezer Model:</label>
            <input type="number" placeholder=" Freezer Model" name="model"><br>
        ...
        <div>
            ...
            <form action='form_freezer.php' method='POST'>
